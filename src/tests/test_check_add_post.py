...
5 - Wait until home page loading   #gerek yok
...
class TestCheckAddPost:
    ...
    def test_check_add_post(self):
        ...
        self.logger.info("1- Open browser and visit https://www.blogger.com/about/")
        ...
        try:
            self.logger.info("2- Click sign in button")
            self.loginpage.clickSignIn()
            self.logger.info("2 -Enter email and click next button")
